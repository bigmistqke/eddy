...
//
// The camera won't hand back arbitrary small resolutions, so this records
// ONCE at capture resolution, then transcodes (downscales + re-encodes)
// to each grid's cell size — a step a real streaming pipeline needs
// anyway — and runs N decoders on the transcoded clip concurrently,
// measuring per-decoder sustained fps. It isolates the question
