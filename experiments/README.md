...
| 24b | [render-loop-hybrid](24b_render-loop-hybrid/README.md) | How many concurrent dirty per-cell streams can coexist with M=4 atlas baseline at K=16 (eventually-consistent atlas pattern)? Sweep D ∈ {0,2,4,8,12}. | _not yet run_ |
