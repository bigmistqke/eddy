...
| 29 | [full-lifecycle](29_full-lifecycle/README.md) | C2 architecture end-to-end at K=16: load (cold-start) → play 10s → record 5s (with playback) → save (RGBA→AV1 parallel encode). Integration test — does the whole flow hold together in one continuous run? | _not yet run_ |
